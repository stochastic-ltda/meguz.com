# Django settings for meguz project.

DEBUG = False
TEMPLATE_DEBUG = DEBUG

ADMINS = (
    ('Pablo', 'pquezada@stochastic.cl'),
)
...
SECRET_KEY = '^3y#(bt*z(pblmz1k-rnhc9wjbvp9s_9h3(7sg0xs#2d^(ibqh'
